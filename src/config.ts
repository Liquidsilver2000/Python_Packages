...
export const siteConfig: SiteConfig = {
  ...
  description: "A unified analytics ecosystem for NumPy, Pandas, Matplotlib, Scikit-learn, TensorFlow, PyTorch, and more.",
  language: "en",
}

export const headerConfig: HeaderConfig = {
  brandMark: "DSCC",
  noteCountSuffix: " modules",
  editorViewLabel: "Docs",
  graphViewLabel: "Graph",
  backgroundButtonTitle: "Toggle Background",
  importButtonLabel: "",
}
...
export const backgroundConfig: BackgroundConfig = {
  ...
  solidColors: [
    ...
    { color: '#1a1308', label: "Sepia" },
    { color: '#0d1f0d', label: "Forest" },
  ],
}

export const sidebarConfig: SidebarConfig = {
  searchPlaceholder: "Search data science modules...",
  noResultsLabel: "No matching modules found",
  emptyNotesLabel: "No modules loaded",
  selectAllLabel: "Select All",
  clearSelectionLabel: "Clear",
  selectedCountSuffix: " selected",
  deleteSelectedLabel: "Delete",
  cancelLabel: "Cancel",
  newNoteLabel: "New Module",
  manageLabel: "Manage",
}
...
export const editorConfig: EditorConfig = {
  ...
  contentPlaceholder: "Use [[Title]] to link modules. Markdown is supported...",
  outgoingLinksLabel: "Outgoing:",
  incomingLinksLabel: "Incoming:",
}

export const graphConfig: GraphConfig = {
  notesLabel: "modules",
  connectionsLabel: "connections",
  emptyGraphLabel: "No modules yet. Create your first module to begin.",
}

export const moonConfig: MoonConfig = {
  phaseLabels: ["New", "Waxing", "First", "Gibbous", "Full", "Disseminating", "Last", "Balsamic"],
}

export const appConfig: AppConfig = {
  emptyStateLabel: "Select or create a module to explore the ecosystem",
}

export const storageConfig: StorageConfig = {
  notesKey: "ds-command-center-v1",
}
...
See also [[Pandas]], [[Scikit-learn]], [[TensorFlow]], [[PyTorch]], [[OpenCV]]`,
    ...
    source: "NumPy v2.0 Documentation",
  },
  {
    title: "Pandas",
...
See also [[NumPy]], [[Matplotlib]], [[Seaborn]], [[SQLAlchemy]], [[BeautifulSoup]]`,
    ...
    source: "Pandas v2.2 Documentation",
  },
  {
    title: "Matplotlib",
...
See also [[NumPy]], [[Pandas]], [[Seaborn]], [[Scikit-learn]], [[OpenCV]], [[Tkinter]]`,
    ...
    source: "Matplotlib v3.9 Documentation",
  },
  {
    title: "Seaborn",
...
See also [[Pandas]], [[Matplotlib]], [[Scikit-learn]], [[NumPy]]`,
    ...
    source: "Seaborn v0.13 Documentation",
  },
  {
    title: "Scikit-learn",
...
See also [[NumPy]], [[Pandas]], [[Matplotlib]], [[TensorFlow]], [[PyTorch]]`,
    ...
    source: "Scikit-learn v1.5 Documentation",
  },
  {
    title: "TensorFlow",
...
See also [[NumPy]], [[Scikit-learn]], [[PyTorch]], [[OpenCV]], [[Pandas]]`,
    ...
    source: "TensorFlow v2.16 Documentation",
  },
  {
    title: "PyTorch",
...
See also [[NumPy]], [[TensorFlow]], [[Scikit-learn]], [[OpenCV]], [[Pandas]]`,
    ...
    source: "PyTorch v2.3 Documentation",
  },
  {
    title: "BeautifulSoup",
...
See also [[Pandas]], [[SQLAlchemy]], [[NumPy]], [[Matplotlib]]`,
    ...
    source: "BeautifulSoup v4.12 Documentation",
  },
  {
    title: "SQLAlchemy",
...
See also [[Pandas]], [[Django]], [[BeautifulSoup]], [[NumPy]]`,
    ...
    source: "SQLAlchemy v2.0 Documentation",
  },
  {
    title: "OpenCV",
...
See also [[NumPy]], [[PyTorch]], [[TensorFlow]], [[Matplotlib]], [[Tkinter]], [[Django]]`,
    ...
    source: "OpenCV v4.9 Documentation",
  },
  {
    title: "Tkinter",
...
See also [[SQLAlchemy]], [[Pandas]], [[Matplotlib]], [[BeautifulSoup]], [[Scikit-learn]]`,
    ...
    source: "Django v5.0 Documentation",
  },
  {
